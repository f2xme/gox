...
| Use object storage (Aliyun, AWS S3, Cloudflare R2, MinIO) | `oss`, `oss/adapter/aliyun`, `oss/adapter/s3` | `github.com/f2xme/gox/oss` |
...
WeChat scans to OAuth + JSAPI and Alipay scans to `Pay` / `TradePrecreate`. Use
